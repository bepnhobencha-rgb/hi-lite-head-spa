  ...
  return (
    <div>
      <section className="relative h-80 md:h-[520px] flex items-end overflow-hidden">
        <img src="https://media.base44.com/images/public/69ca33f058b56f86689a61f3/c46ef07d2_d4b8c31b177761b606d3352dd9974dc57073b832dd350d2f2563cacf67812ff4.png" alt="Gift card for head spa" className="absolute inset-0 w-full h-full object-cover" style={{ filter: "brightness(1.05) contrast(1.04) saturate(0.82) sepia(0.08)" }} />

  ...
  return (
    <div>
      <section className="relative h-80 md:h-[520px] flex items-end overflow-hidden">
        <img src="https://media.base44.com/images/public/69ca33f058b56f86689a61f3/195d14503_Gemini_Generated_Image_qs7xblqs7xblqs7x.png" alt="Head spa treatment" className="absolute inset-0 w-full h-full object-cover object-center" style={{ imageRendering: "auto", filter: "brightness(1.06) contrast(1.04) saturate(0.80) sepia(0.10)" }} />

  ...
  return (
    <div>
      <section className="relative h-80 md:h-[520px] flex items-end overflow-hidden">
        <img src="/images/ecf253af2_Unknown-37.jpg" alt="HI-LITE HEAD SPA reception" className="absolute inset-0 w-full h-full object-cover object-center" style={{ filter: "brightness(0.88) contrast(1.06) saturate(0.72) sepia(0.14)" }} />

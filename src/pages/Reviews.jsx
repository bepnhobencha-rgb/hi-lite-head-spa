  ...
  return (
    <div>
      <section className="relative h-80 md:h-[520px] flex items-end overflow-hidden">
        <img src="https://media.base44.com/images/public/69ca33f058b56f86689a61f3/1a0637449_Unknown-63.jpg" alt="Relaxing head spa" className="absolute inset-0 w-full h-full object-cover object-center" />
